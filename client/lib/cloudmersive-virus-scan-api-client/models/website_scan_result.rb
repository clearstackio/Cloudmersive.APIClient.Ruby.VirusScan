  ...
  class WebsiteScanResult
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CloudmersiveVirusScanApiClient::WebsiteScanResult` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CloudmersiveVirusScanApiClient::WebsiteScanResult`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'website_threat_type')
        self.website_threat_type = attributes[:'website_threat_type']
      end
      ...
      if attributes.key?(:'website_http_response_code')
        self.website_http_response_code = attributes[:'website_http_response_code']
      end
    end
