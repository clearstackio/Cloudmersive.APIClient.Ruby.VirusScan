  ...
  class CloudStorageAdvancedVirusScanResult
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CloudmersiveVirusScanApiClient::CloudStorageAdvancedVirusScanResult` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CloudmersiveVirusScanApiClient::CloudStorageAdvancedVirusScanResult`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'clean_result')
        self.clean_result = attributes[:'clean_result']
      end

      if attributes.key?(:'contains_executable')
        self.contains_executable = attributes[:'contains_executable']
      end

      if attributes.key?(:'contains_invalid_file')
        self.contains_invalid_file = attributes[:'contains_invalid_file']
      end

      if attributes.key?(:'contains_script')
        self.contains_script = attributes[:'contains_script']
      end

      if attributes.key?(:'contains_password_protected_file')
        self.contains_password_protected_file = attributes[:'contains_password_protected_file']
      end

      if attributes.key?(:'contains_restricted_file_format')
        self.contains_restricted_file_format = attributes[:'contains_restricted_file_format']
      end

      if attributes.key?(:'contains_macros')
        self.contains_macros = attributes[:'contains_macros']
      end

      if attributes.key?(:'contains_xml_external_entities')
        self.contains_xml_external_entities = attributes[:'contains_xml_external_entities']
      end

      if attributes.key?(:'contains_insecure_deserialization')
        self.contains_insecure_deserialization = attributes[:'contains_insecure_deserialization']
      end

      if attributes.key?(:'contains_html')
        self.contains_html = attributes[:'contains_html']
      end

      if attributes.key?(:'contains_unsafe_archive')
        self.contains_unsafe_archive = attributes[:'contains_unsafe_archive']
      end

      if attributes.key?(:'contains_ole_embedded_object')
        self.contains_ole_embedded_object = attributes[:'contains_ole_embedded_object']
      end

      if attributes.key?(:'verified_file_format')
        self.verified_file_format = attributes[:'verified_file_format']
      end

      if attributes.key?(:'found_viruses')
        if (value = attributes[:'found_viruses']).is_a?(Array)
          self.found_viruses = value
        end
      end

      if attributes.key?(:'error_detailed_description')
        self.error_detailed_description = attributes[:'error_detailed_description']
      end
      ...
      if attributes.key?(:'content_information')
        self.content_information = attributes[:'content_information']
      end
    end
    ...
    def hash
      [successful, clean_result, contains_executable, contains_invalid_file, contains_script, contains_password_protected_file, contains_restricted_file_format, contains_macros, contains_xml_external_entities, contains_insecure_deserialization, contains_html, contains_unsafe_archive, contains_ole_embedded_object, verified_file_format, found_viruses, error_detailed_description, file_size, content_information].hash
    end
    ...
    def self._deserialize(type, value)
      ...
      when /\AHash<(?<k_type>.+?), (?<v_type>.+)>\z/
        ...
        klass = CloudmersiveVirusScanApiClient.const_get(type)
