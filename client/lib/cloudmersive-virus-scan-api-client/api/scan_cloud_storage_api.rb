...
module CloudmersiveVirusScanApiClient
  class ScanCloudStorageApi
    ...
    # @param access_key [String] AWS S3 access key for the S3 bucket; you can get this from My Security Credentials in the AWS console
    # @param secret_key [String] AWS S3 secret key for the S3 bucket; you can get this from My Security Credentials in the AWS console
    # @param bucket_region [String] Name of the region of the S3 bucket, such as &#39;US-East-1&#39;
    # @param bucket_name [String] Name of the S3 bucket
    # @param key_name [String] Key name (also called file name) of the file in S3 that you wish to scan for viruses.  If the key name contains Unicode characters, you must base64 encode the key name and prepend it with &#39;base64:&#39;, such as: &#39;base64:6ZWV6ZWV6ZWV6ZWV6ZWV6ZWV&#39;.
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :role_arn Optional: Role ARN for STS Credential-based access.  This is for advanced access using the Security Token Service and is not required.  If the roleArn contains Unicode characters, you must base64 encode the key name and prepend it with &#39;base64:&#39;, such as: &#39;base64:6ZWV6ZWV6ZWV6ZWV6ZWV6ZWV&#39;.
    # @return [Array<(CloudStorageVirusScanResult, Integer, Hash)>] CloudStorageVirusScanResult data, response status code and response headers
    def scan_cloud_storage_scan_aws_s3_file_with_http_info(access_key, secret_key, bucket_region, bucket_name, key_name, opts = {})
      ...
      header_params['Accept'] = @api_client.select_header_accept(['application/json', 'text/json', 'application/xml', 'text/xml']) unless header_params['Accept']
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CloudStorageVirusScanResult'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Apikey']

      new_options = opts.merge(
        :operation => :"ScanCloudStorageApi.scan_cloud_storage_scan_aws_s3_file",
    ...
    # @option opts [String] :options Comma separated set of configuration operations.  Include permitJavascriptAndHtmlInPDFs to allow JavaScript and HTML in PDF files.  Include blockOfficeXmlOleEmbeddedFile to block embedded OLE files in Office Documents using the modern file format.  Default is no options.
    ...
    # @option opts [String] :options Comma separated set of configuration operations.  Include permitJavascriptAndHtmlInPDFs to allow JavaScript and HTML in PDF files.  Include blockOfficeXmlOleEmbeddedFile to block embedded OLE files in Office Documents using the modern file format.  Default is no options.
    # @option opts [String] :restrict_file_types Specify a restricted set of file formats to allow as clean as a comma-separated list of file formats, such as .pdf,.docx,.png would allow only PDF, PNG and Word document files.  All files must pass content verification against this list of file formats, if they do not, then the result will be returned as CleanResult&#x3D;false.  Set restrictFileTypes parameter to null or empty string to disable; default is disabled.
    # @return [Array<(CloudStorageAdvancedVirusScanResult, Integer, Hash)>] CloudStorageAdvancedVirusScanResult data, response status code and response headers
    def scan_cloud_storage_scan_aws_s3_file_advanced_with_http_info(access_key, secret_key, bucket_region, bucket_name, key_name, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CloudStorageAdvancedVirusScanResult'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Apikey']

      new_options = opts.merge(
        :operation => :"ScanCloudStorageApi.scan_cloud_storage_scan_aws_s3_file_advanced",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param connection_string [String] Connection string for the Azure Blob Storage Account; you can get this connection string from the Access Keys tab of the Storage Account blade in the Azure Portal.
    # @param container_name [String] Name of the Blob container within the Azure Blob Storage account
    # @param blob_path [String] Path to the blob within the container, such as &#39;hello.pdf&#39; or &#39;/folder/subfolder/world.pdf&#39;.  If the blob path contains Unicode characters, you must base64 encode the blob path and prepend it with &#39;base64:&#39;, such as: &#39;base64:6ZWV6ZWV6ZWV6ZWV6ZWV6ZWV&#39;.
    # @param [Hash] opts the optional parameters
    # @return [CloudStorageVirusScanResult]
    ...
    def scan_cloud_storage_scan_azure_blob_with_http_info(connection_string, container_name, blob_path, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ScanCloudStorageApi.scan_cloud_storage_scan_azure_blob",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def scan_cloud_storage_scan_azure_blob_advanced_with_http_info(connection_string, container_name, blob_path, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ScanCloudStorageApi.scan_cloud_storage_scan_azure_blob_advanced",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param bucket_name [String] Name of the bucket in Google Cloud Storage
    # @param object_name [String] Name of the object or file in Google Cloud Storage.  If the object name contains Unicode characters, you must base64 encode the object name and prepend it with &#39;base64:&#39;, such as: &#39;base64:6ZWV6ZWV6ZWV6ZWV6ZWV6ZWV&#39;.
    # @param json_credential_file [File] Service Account credential for Google Cloud stored in a JSON file.
    # @param [Hash] opts the optional parameters
    # @return [CloudStorageVirusScanResult]
    ...
    def scan_cloud_storage_scan_gcp_storage_file_with_http_info(bucket_name, object_name, json_credential_file, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ScanCloudStorageApi.scan_cloud_storage_scan_gcp_storage_file",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def scan_cloud_storage_scan_gcp_storage_file_advanced_with_http_info(bucket_name, object_name, json_credential_file, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ScanCloudStorageApi.scan_cloud_storage_scan_gcp_storage_file_advanced",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param client_id [String] Client ID access credentials; see description above for instructions on how to get the Client ID from the Azure Active Directory portal.
    # @param client_secret [String] Client Secret access credentials; see description above for instructions on how to get the Client Secret from the Azure Active Directory portal
    # @param sharepoint_domain_name [String] SharePoint Online domain name, such as mydomain.sharepoint.com
    # @param site_id [String] Site ID (GUID) of the SharePoint site you wish to retrieve the file from
    # @param file_path [String] Path to the file within the drive, such as &#39;hello.pdf&#39; or &#39;/folder/subfolder/world.pdf&#39;.  If the file path contains Unicode characters, you must base64 encode the file path and prepend it with &#39;base64:&#39;, such as: &#39;base64:6ZWV6ZWV6ZWV6ZWV6ZWV6ZWV&#39;.
    # @param [Hash] opts the optional parameters
    ...
    def scan_cloud_storage_scan_share_point_online_file_with_http_info(client_id, client_secret, sharepoint_domain_name, site_id, file_path, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ScanCloudStorageApi.scan_cloud_storage_scan_share_point_online_file",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def scan_cloud_storage_scan_share_point_online_file_advanced_with_http_info(client_id, client_secret, sharepoint_domain_name, site_id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ScanCloudStorageApi.scan_cloud_storage_scan_share_point_online_file_advanced",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
