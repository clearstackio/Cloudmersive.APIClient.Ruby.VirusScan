...
module CloudmersiveVirusScanApiClient
  class ScanApi
    ...
    # @param input_file [File] Input file to perform the operation on.
    ...
    # @param input_file [File] Input file to perform the operation on.
    # @param [Hash] opts the optional parameters
    # @return [Array<(VirusScanResult, Integer, Hash)>] VirusScanResult data, response status code and response headers
    def scan_file_with_http_info(input_file, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'VirusScanResult'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Apikey']

      new_options = opts.merge(
        :operation => :"ScanApi.scan_file",
    ...
    # @option opts [Boolean] :allow_scripts Set to false to block script files, such as a PHP files, Python scripts, BAT scripts, JS scripts, and other malicious content or security threats that can be embedded in the file.  Set to true to allow these file types.  Default is false (recommended).
    ...
    # @option opts [String] :options Comma separated set of configuration operations.  Include permitJavascriptAndHtmlInPDFs to allow JavaScript and HTML in PDF files.  Include blockOfficeXmlOleEmbeddedFile to block embedded OLE files in Office Documents using the modern file format.  Include blockInvalidUris to block invalid URIs in Office documents.  Default is no options.
    # @option opts [String] :restrict_file_types Specify a restricted set of file formats to allow as clean as a comma-separated list of file formats, such as .pdf,.docx,.png would allow only PDF, PNG and Word document files.  All files must pass content verification against this list of file formats, if they do not, then the result will be returned as CleanResult&#x3D;false.  Set restrictFileTypes parameter to null or empty string to disable; default is disabled.
    # @return [Array<(VirusScanAdvancedResult, Integer, Hash)>] VirusScanAdvancedResult data, response status code and response headers
    def scan_file_advanced_with_http_info(input_file, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'VirusScanAdvancedResult'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Apikey']

      new_options = opts.merge(
        :operation => :"ScanApi.scan_file_advanced",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param input [WebsiteScanRequest] 
    # @param [Hash] opts the optional parameters
    ...
    # @param input [WebsiteScanRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(WebsiteScanResult, Integer, Hash)>] WebsiteScanResult data, response status code and response headers
    def scan_website_with_http_info(input, opts = {})
      ...
      header_params['Accept'] = @api_client.select_header_accept(['application/json', 'text/json', 'application/xml', 'text/xml']) unless header_params['Accept']
      # HTTP header 'Content-Type'
      content_type = @api_client.select_header_content_type(['application/json', 'text/json', 'application/xml', 'text/xml', 'application/x-www-form-urlencoded'])
      if !content_type.nil?
          header_params['Content-Type'] = content_type
      end
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(input)

      # return_type
      return_type = opts[:debug_return_type] || 'WebsiteScanResult'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Apikey']

      new_options = opts.merge(
        :operation => :"ScanApi.scan_website",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
